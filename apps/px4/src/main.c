...
} env_t; /* AWH - Defined env type */
#if 0 /* AWH */
#include <sel4test/test.h>
#define TESTS_APP "sel4test-tests"
#else
#define TESTS_APP "px4_firmware"
#endif /* AWH */
...
#endif /* AWH */
{
    ...
    /* copy test name */
    strncpy(env.init->name, "px4_firmware"/*AWH test->name + strlen("TEST_")*/, TEST_NAME_MAX);
...
#if 0 /* AWH */
        sel4utils_print_fault_message(info, /* AWH test->name*/ "px4_firmware");
        result = FAILURE;
#else
	result = (-1);
#endif /* AWH */
...
int main(void)
{
...
#ifdef SEL4_DEBUG_KERNEL
    seL4_DebugNameThread(seL4_CapInitThreadTCB, /* AWH "sel4test-driver"*/ "px4_firmware-driver");
#endif
    ...
    fflush(stdout);
    /* AWH int res = (int)*/sel4utils_run_on_stack(&env.vspace, main_continued, NULL);
#if 0 /* AWH */
